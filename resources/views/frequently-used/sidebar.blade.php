		...
		<nav id="sidebar">
			<div class="p-4 pt-5">
				...
				<ul class="list-unstyled components mb-5">
					<li>
						<a href="{{url('/dashboard')}}" class="d-flex" style="align-items: center;gap:60px;"><ion-icon name="grid-outline" style="font-size: 20px;"></ion-icon>Dashboard</a>
					</li>
					<li>
						<a href="{{url('/dashboard/restaurant-list')}}" class="d-flex" style="align-items: center;gap:60px;"><ion-icon name="home-outline" style="font-size: 20px;"></ion-icon>Restaurant</a>
					</li>
					<li>
						<a href="{{url('/dashboard/customer-list')}}" class="d-flex" style="align-items: center;gap:60px;"><ion-icon name="person-outline" style="font-size: 20px;"></ion-icon>Customer</a>
					</li>
					<li>
						<a href="{{url('/dashboard/customer-message')}}" class="d-flex" style="align-items: center;gap:60px;"><ion-icon name="mail-outline" style="font-size: 20px;"></ion-icon>Message</a>
					</li>
				</ul>
